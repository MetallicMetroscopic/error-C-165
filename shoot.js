AFRAME.registerComponent("bullets", {
  ...
  removeBullet: function (e) {
    ...
    if (elementHit.id.includes("enemy")) {
      //Add code here
      var countTank_el = document.querySelector("#countTank")
      var tanksShot = parseInt(countTank_el.getAttribute("text").value)
      tanksShot -= 1
      countTank_el.setAttribute("text", {value: tanksShot})
      if(tanksShot == 0){
        var winText = document.querySelector("#completed")
